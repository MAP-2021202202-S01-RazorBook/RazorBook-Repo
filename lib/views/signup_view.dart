                ...
                children: <Widget>[
                  ...
                  confirmButton(context, "Continue", (){
                    if(_dropdownValue == "barber"){
                     ...
                     MaterialPageRoute(builder: (context) => BarberSignupView()));
                     }
                     else{
                       Navigator.push(context,
                     MaterialPageRoute(builder: (context) => CustomerSignupView()));
                     }
            ...
            padding: EdgeInsets.fromLTRB(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  inputField("Shop Name", Icons.mail_outline, false, shopNameController),
                  SizedBox(
                    height: 20,
                  ),
                  inputField("Contact Number", Icons.person_outline, false, contactController),
                  SizedBox(height: 20,
                  ),
                  inputField("Location", Icons.mail_outline, false, locationController),
                  SizedBox(height: 20,
                  ),
                  inputField("Location on Map", Icons.mail_outline, false, locationOnMapController),
                  SizedBox(height: 20,
                  ),
                  ...
                  confirmButton(context, "Sign Up", (){
                    
                    barberInfo(shopNameController.text, contactController.text, locationController.text, locationOnMapController.text, emailController.text, passwordController.text);
            ...
            padding: EdgeInsets.fromLTRB(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  inputField("Full Name", Icons.person_outline, false, nameController),
                  SizedBox(
                    height: 20,
                  ),
                  ...
                  inputField("Gender", Icons.person_outline, false, genderController),
                  SizedBox(height: 20,
                  ),
                  inputField("Contact Number", Icons.mail_outline, false, contactController),
                  SizedBox(height: 20,
                  ),
                  inputField("Email", Icons.mail_outline, false, emailController),
                  SizedBox(height: 20,
                  ...
                  confirmButton(context, "Sign Up", (){
                     ...
                     try {
                        customerInfo( nameController.text,  ageController.text,  genderController.text,
                     contactController.text,  emailController.text,  passwordController.text);
                      } catch(e) {
                        print("errorrrrrrrrrrrrr ${e.toString()}");
                        CustomerSignupView();
                      }
                     Navigator.push(context,
                     MaterialPageRoute(builder: (context) => Home()));
